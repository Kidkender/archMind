...
describe("FINDING_TYPES drift guard", () => {
  const MAPPED_TYPES = new Set([
    ...
    FINDING_TYPES.RESOURCE_MISMATCH,
    FINDING_TYPES.RESOURCE_UNPROTECTED,
    FINDING_TYPES.FAT_CONTROLLER,
    FINDING_TYPES.EXPOSED_READ_ENDPOINT,
    FINDING_TYPES.OVER_AUTHORIZED_ROUTE,
    FINDING_TYPES.DEAD_MIDDLEWARE,
    FINDING_TYPES.CIRCULAR_DEPENDENCY,
    FINDING_TYPES.SENSITIVE_FIELD_EXPOSED,
    FINDING_TYPES.SYNCHRONOUS_MAIL,
    FINDING_TYPES.API_RESOURCE_UNPROTECTED,
  ])
