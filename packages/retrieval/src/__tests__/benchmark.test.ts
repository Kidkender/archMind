...
const GRAPHS: Record<string, IntermediateExecutionGraph[]> = {
  "LARAVEL-AUTH-001": [{
    ...
    nodes: [
      ...
      { id: "fr",   type: "form_request",         symbol: "UpdateTaskRequest::authorize", role: "validation",     file: "app/Modules/Task/Requests/UpdateTaskRequest.php" },
      { id: "pol",  type: "policy",               symbol: "TaskPolicy::update",           role: "authorization",  file: "app/Policies/TaskPolicy.php" },
    ],
    edges: [
  ...
  "LARAVEL-AUTH-002": [{
    ...
    nodes: [
      ...
      { id: "mw_2", type: "authorization_check",  symbol: "CheckPermission::handle",   role: "authorization", args: ["task.delete"] },
      { id: "ctrl", type: "controller_action",    symbol: "TaskController::destroy",   role: "handler" },
      { id: "pol",  type: "policy",               symbol: "TaskPolicy::delete",        role: "authorization" },
    ],
    edges: [
      { from: "mw_0", to: "mw_1", relation: "next_middleware", traceability: "static" },
      { from: "mw_1", to: "mw_2", relation: "next_middleware", traceability: "static" },
